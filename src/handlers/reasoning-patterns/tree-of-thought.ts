...
import {
  ...
  TreeOfThoughtMetadata
} from '../../types/reasoning-patterns/tree-of-thought.js';
import { ThoughtData } from '../../types/index.js';

export class TreeOfThoughtHandler implements TreeOfThoughtOperations {
  private readonly defaultConfig: TreeOfThoughtConfig = {
    maxDepth: 10,
  ...
  initializeSession(config?: Partial<TreeOfThoughtConfig>): TreeOfThoughtSession {
    ...
    const nodes = new Map<string, TreeOfThoughtNode>();
